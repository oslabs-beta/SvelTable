<!-- <script>
	...
	const data = [
		...
		{ id: 1, name: 'tom', hobby: 'biking', city: 'dallas', favnum: 36 },
		{ id: 2, name: 'care', hobby: 'dancing', city: 'chicago', favnum: 36 },
...
<script>
	...
	function newPerson(num) {
		...
		return {
			...
			sex: sexAssigner > 0.75 ? 'prefer not to say' : sexAssigner > 0.25 ? 'male' : 'female',
